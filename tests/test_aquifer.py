...
def test_aquifer_potential_to_elevation():
    aq = Aquifer(500.0, 100.0, 0.25, 1.0)
    elevation = aq.potential_to_elevation(20000.0)
    assert elevation == 750.0


def test_aquifer_discharge_to_velocity():
    aq = Aquifer(500.0, 100.0, 0.25, 1.0)
